...
public class PrivateServiceImpl implements PrivateService {
    ...
    //-------------------------------------------------Private: События-------------------------------------------------
    @Override
    public List<Event> getEventsByInitiator(int userId, int from, int size) {
        ...
        return from < events.size() ? events.subList(from, events.size()) : new ArrayList<>();
    }

    @Override
    @Transactional
    public Event addEvent(Event newEvent, int userId) {
        //check user existence
    ...
    @Override
    @Transactional
    public Event updateEventByInitiator(int userId, int eventId, UpdateEventUserRequest eventUpdate) {
        //check user existence
        if (!userRepository.existsById(userId)) {
            throw new NotFoundException("User with id=" + userId + " was not found");
        }
    ...
    @Override
    public List<ParticipationRequest> getRequestsForEventByInitiator(int userId, int eventId) {
        //check user existence
        if (!userRepository.existsById(userId)) {
            throw new NotFoundException("User with id=" + userId + " was not found");
        }
    ...
    @Override
    @Transactional
    public EventRequestStatusUpdateResult updateStatusOfRequestsByInitiator(int userId, int eventId, EventRequestStatusUpdateRequest requestStatusUpdates) {
        //check user existence
        if (!userRepository.existsById(userId)) {
            throw new NotFoundException("User with id=" + userId + " was not found");
        }
    ...
    @Override
    public List<ParticipationRequest> getParticipationsByRequester(int userId) {
        //check user existence
        if (!userRepository.existsById(userId)) {
            throw new NotFoundException("User with id=" + userId + " was not found");
        }
    ...
    @Override
    @Transactional
    public ParticipationRequest addParticipationRequest(int userId, int eventId) {
        //check user existence
    ...
    @Override
    @Transactional
    public ParticipationRequest cancelParticipationByRequester(int userId, int requestId) {
        //check user existence
